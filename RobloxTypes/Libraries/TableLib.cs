...
public static class table
{
    ...
    /// </summary>
    public static extern void clear(object t);
    ...
    /// </summary>
    public static extern T[] create<T>(int count, T? value = default);
    ...
    /// </summary>
    public static extern void sort<T>(T[] t, Func<T, T, bool>? comp = null);
    ...
    /// </summary>
    public static extern T[] freeze<T>(T t);

    /// <summary>Returns whether or not the list is frozen.</summary>
    public static extern bool isfrozen<T>(T t);
    ...
    /// </summary>
    public static extern T clone<T>(T t);
    ...
    // why didn't i document this?? must've gotten lazy lol
    public static extern void insert<T>(T[] t, T value);

    public static extern void insert<T>(T[] t, uint index, T value);

    public static extern T? remove<T>(T[] t, uint? index = null);

    public static extern T[] move<T>(T[] src, uint a, uint b, uint t, T[]? dst = null!);

    public static extern string concat(object[] t, string? sep = null, uint? i = null, uint? j = null);

    public static extern uint? find<T>(T[] t, T value, uint? init = null);
}