...
public static class utf8
{
    ...
    public static extern string charpattern { get; set; }
    ...
    public static extern string @char(params uint[] codepoints);
    ...
    /// </summary>
    public static extern IEnumerable<(uint, uint)> codes(string str);
    ...
    /// </summary>
    public static extern uint[] codepoint(string s, int? i = null, int? j = null); // TODO: use LuaTuple type?
    ...
    /// </summary>
    public static extern uint len(string s, int? i = null, int? j = null);
    ...
    /// </summary>
    public static extern uint offset(string s, int n, int? i = null);
    ...
    public static extern string nfcnormalize(string str);
    ...
    public static extern string nfdnormalize(string str);
}