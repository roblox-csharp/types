...
public static class debug
{
    ...
    /// </summary>
    public static extern string traceback(string message, int? level = null);
    ...
    /// <para>Note that this function will often return inaccurate results (compared to the original source code) and that the format of the returned traceback may change at any time. You should not parse the return value for specific information such as script names or line numbers.</para>
    /// </summary>
    public static extern string traceback(thread thread, string message, int? level = null);
    ...
    /// </summary>
    public static extern object[] info(int level, string options); // TODO: use LuaTuple type?
    ...
    public static extern void profilebegin();

    /// <summary>Returns the name of the current thread's active memory category.</summary>
    public static extern string getmemorycategory();
    ...
    /// </summary>
    public static extern string setmemorycategory(string tag);
    ...
    /// </summary>
    public static extern void dumpcodesize();
}