...
public static class buffer
{
    ...
    public static extern Buffer create(uint size);

    /// <summary>Creates a buffer from a string.</summary>
    public static extern Buffer fromstring(string str);

    /// <summary>Converts a buffer to a string.</summary>
    public static extern string tostring(Buffer b);

    /// <summary>SReturns the size of the buffer in bytes.</summary>
    public static extern uint len(Buffer b);
    ...
    public static extern sbyte readi8(Buffer b, uint offset);
    ...
    public static extern byte readu8(Buffer b, uint offset);
    ...
    public static extern short readi16(Buffer b, uint offset);
    ...
    public static extern ushort readu16(Buffer b, uint offset);
    ...
    public static extern int readi32(Buffer b, uint offset);
    ...
    public static extern uint readu32(Buffer b, uint offset);
    ...
    /// </summary>
    public static extern float readf32(Buffer b, uint offset);
    ...
    /// <para>If the floating-point value matches any bit patterns that represent NaN (not a number), the returned value may be converted to a different quiet NaN representation.</para>
    /// </summary>
    public static extern double readf64(Buffer b, uint offset);
    ...
    public static extern void writei8(Buffer b, uint offset, sbyte value);
    ...
    public static extern void writeu8(Buffer b, uint offset, byte value);
    ...
    public static extern void writei16(Buffer b, uint offset, short value);
    ...
    public static extern void writeu16(Buffer b, uint offset, ushort value);
    ...
    public static extern void writei32(Buffer b, uint offset, int value);
    ...
    public static extern void writeu32(Buffer b, uint offset, uint value);
    ...
    public static extern void writef32(Buffer b, uint offset, float value);
    ...
    public static extern void writef64(Buffer b, uint offset, double value);

    /// <summary>Reads a string of length count from the buffer at the specified offset.</summary>
    public static extern string readstring(Buffer b, uint offset, uint count);
    ...
    public static extern void writestring(Buffer b, uint offset, string value, uint count);
    ...
    public static extern void fill(Buffer b, uint offset, byte value, uint count);
}